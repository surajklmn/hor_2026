import { Layers, Map, Type, Plus, Minus } from "lucide-react";
  ...
  return (
    <div className="absolute top-4 right-4 z-[400] flex flex-col gap-2">
      ...
      <div className="flex flex-col rounded-lg shadow-md border border-gray-200 overflow-hidden">
        <button
          onClick={onZoomIn}
          className="bg-white p-3 hover:bg-gray-50 transition-all border-b border-gray-200"
          title="Zoom in"
        >
        ...
        <button
          onClick={onZoomOut}
          className="bg-white p-3 hover:bg-gray-50 transition-all"
          title="Zoom out"
        >
      ...
      <button
        ...
        title={
          isSatellite ? "Switch to Election Mode" : "Switch to Satellite Mode"
        }
      >
        {isSatellite ? (
      ...
      <button
        ...
        title={
          showDistrictNames ? "Hide District Names" : "Show District Names"
        }
      >
        <Type
          size={24}
          className={showDistrictNames ? "text-blue-600" : "text-gray-700"}
        />
